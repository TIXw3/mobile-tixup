...
void main() {
  group('ShopScreen Tests', () {
    ...
    testWidgets('Exibe AppBar e texto "Carrinho" quando está vazio', (tester) async {
    ...
    testWidgets('Exibe mensagem e botão "Compre seu ingresso agora!" quando carrinho está vazio', (tester) async {
      final viewModel = TestShopViewModel();
      await tester.pumpWidget(createTestWidget(viewModel: viewModel));
    ...
    testWidgets('Navega para TelaPesquisa ao clicar em "Compre seu ingresso agora!"', (tester) async {
      final viewModel = TestShopViewModel();
      await tester.pumpWidget(createTestWidget(viewModel: viewModel));
    ...
    testWidgets('Exibe CircularProgressIndicator quando isLoading é true', (tester) async {
    ...
    testWidgets('Exibe lista de carrinho e botão "Finalizar Compra" quando há itens', (tester) async {
      final viewModel = TestShopViewModel();
